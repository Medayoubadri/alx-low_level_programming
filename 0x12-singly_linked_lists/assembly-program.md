...
Example: mov rax, 5 – Put the number 5 into the rax register.
add and sub: Adds or subtracts values.

Example: add rax, rbx – Adds the value in rbx to rax.
call: Calls a function.

Example: call printf – Calls the printf function.
ret: Returns from a function.

Example: ret – Ends the function and returns control to the calling code.
